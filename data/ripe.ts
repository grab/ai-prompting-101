import { RipeKey, RipeSection } from "@/types";

export const ripeSections: RipeSection[] = [
  {
    key: "role",
    label: "Role",
    shortLabel: "R",
  ...
  },
  {
    ...
    description:
      "Be specific about the thing you want done. \"Help me with my resume\" is a wish. \"Rewrite this bullet to show impact\" is an instruction.",
    placeholder:
    ...
    tips: [
      ...
      "One instruction at a time beats a giant list.",
...
export const ripeOrder: RipeKey[] = ["role", "instructions", "parameters", "expected"];
