...
Paste the JD and the 1–2 worries. Then I'll ask the opener.`}}];e.s(["difficultyLabels",0,{beginner:{label:"Beginner",color:"bg-emerald-100 text-emerald-700"},intermediate:{label:"Intermediate",color:"bg-amber-100 text-amber-700"},advanced:{label:"Advanced",color:"bg-rose-100 text-rose-700"}},"practiceScenarios",0,a],89416),e.s(["quizConfig",0,{passingScore:70,questionsPerQuiz:10},"quizQuestions",0,[{id:"p-1",type:"multiple-choice",question:"Why does giving AI more Parameters usually help?",options:[{id:"a",text:"It makes the prompt look more impressive."},{id:"b",text:"Without parameters, AI guesses — and often guesses wrong about you."},{id:"c",text:"AI charges less when the prompt is longer."},{id:"d",text:"It's polite."}],correctAnswer:"b",explanation:"When AI doesn't know your situation, it fills gaps with generic patterns from training data. Real parameters = less guessing, more useful answers.",concept:"parameters"},{id:"p-2",type:"identify-issue",question:"What's the main issue with this prompt?",context:"Give me advice on managing money.",options:[{id:"a",text:"It's missing who the AI should be."},{id:"b",text:"It has no parameters — income, goals, situation."},{id:"c",text:"The output format isn't specified."},{id:"d",text:"All of the above, but no parameters is the biggest."}],correctAnswer:"d",explanation:"All four RIPE letters are missing. Parameters (income, costs, goals) is the biggest gap — without it, you'll get generic 'make a budget' advice.",concept:"parameters"},{id:"p-3",type:"multiple-choice",question:"Which kind of parameters are MOST useful to include?",options:[{id:"a",text:"Your complete life story."},{id:"b",text:"Constraints, feelings, and the 1–2 things that would change the answer."},{id:"c",text:"Everything you know about the topic."},{id:"d",text:"Nothing — AI should just know."}],correctAnswer:"b",explanation:"Useful parameters aren't quantity — it's relevance. The stuff that would change the answer: your budget, your time, your constraints, your feelings.",concept:"parameters"},{id:"i-1",type:"multiple-choice",question:"Which of these is a proper Instruction?",options:[{id:"a",text:"Help me with my resume."},{id:"b",text:"Can you look at my resume please."},{id:"c",text:"Rewrite this bullet to show impact instead of activity."},{id:"d",text:"Tell me about resumes."}],correctAnswer:"c",explanation:"Option C uses a specific verb (rewrite) and a specific goal (impact vs activity). That's a real instruction — the others are wishes.",concept:"instructions"},{id:"i-2",type:"identify-issue",question:"How would you improve this prompt's Instructions?",context:"You're a career coach. Help me.",options:[{id:"a",text:"Remove the role."},{id:"b",text:"Replace 'Help me' with a specific verb and one deliverable."},{id:"c",text:"Add more roles."},{id:"d",text:"Add a please."}],correctAnswer:"b",explanation:"'Help me' is vague — AI will guess. 'Rewrite my LinkedIn headline in 10 words' is an actual instruction.",concept:"instructions"},{id:"r-1",type:"multiple-choice",question:"Which role is most useful for getting honest essay feedback?",options:[{id:"a",text:"Be helpful."},{id:"b",text:"You are an AI assistant."},{id:"c",text:"Act like the toughest-but-fairest tutor I've ever had."},{id:"d",text:"Be nice."}],correctAnswer:"c",explanation:"A specific role with a specific vibe (tough-but-fair) activates a certain voice. 'Be helpful' is the default — and it's why feedback often feels soft.",concept:"role"},{id:"r-2",type:"multiple-choice",question:"What does giving AI a Role actually change?",options:[{id:"a",text:"Nothing — it's just roleplay."},{id:"b",text:"Its voice, focus, and the kind of details it volunteers."},{id:"c",text:"The length of the response."},{id:"d",text:"It makes AI cost more."}],correctAnswer:"b",explanation:"Role shifts what AI prioritises. A recruiter notices different things than a friend — same content, different lens.",concept:"role"},{id:"e-1",type:"multiple-choice",question:"Which expected output will give you the most usable answer?",options:[{id:"a",text:"Make it good."},{id:"b",text:"Keep it short."},{id:"c",text:"Give me 3 bullets, each under 15 words, written like a friend."},{id:"d",text:"Whatever you think."}],correctAnswer:"c",explanation:"'Short' is subjective. '3 bullets, under 15 words, like a friend' is concrete — you'll get something you can actually use.",concept:"expected"},{id:"e-2",type:"identify-issue",question:"What's missing from this prompt's Expected output?",context:"Act as a budget coach. I earn $800/month. Give me tips.",options:[{id:"a",text:"Format, length, and vibe."},{id:"b",text:"The role."},{id:"c",text:"The parameters."},{id:"d",text:"Nothing — it's fine."}],correctAnswer:"a",explanation:"AI will default to a wall of generic tips. Ask for a table, a top-3 list, or a specific word count — whatever you can actually use.",concept:"expected"},{id:"s-1",type:"multiple-choice",question:"Which of these should you NOT paste into a free AI tool?",options:[{id:"a",text:"A rough draft of your personal statement."},{id:"b",text:"A lecture slide to summarise."},{id:"c",text:"Your bank statement with your full account number."},{id:"d",text:"A recipe you're trying to halve."}],correctAnswer:"c",explanation:"Treat AI like a stranger on public transport. Don't paste passwords, full IDs, account numbers, or anything you wouldn't say out loud.",concept:"safety"}]],35203),e.s([],98640);var o=e.i(43476),s=e.i(71645);let i=(0,s.forwardRef)(({className:e="",variant:t="primary",size:a="md",children:s,...i},r)=>(0,o.jsx)("button",{ref:r,className:`inline-flex items-center justify-center font-medium rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${{primary:"bg-gradient-to-r from-rose-500 to-violet-500 text-white hover:from-rose-600 hover:to-violet-600 focus:ring-rose-400 shadow-sm",secondary:"bg-white text-slate-900 border border-slate-200 hover:border-rose-300 hover:text-rose-600 focus:ring-rose-400",ghost:"bg-transparent text-slate-600 hover:bg-rose-50 hover:text-rose-700 focus:ring-rose-400",outline:"border-2 border-rose-300 text-rose-700 hover:bg-rose-50 focus:ring-rose-400"}[t]} ${{sm:"px-3 py-1.5 text-sm",md:"px-5 py-2 text-base",lg:"px-6 py-3 text-lg"}[a]} ${e}`,...i,children:s}));i.displayName="Button",e.s(["Button",()=>i],76525);let r=(0,s.forwardRef)(({className:e="",variant:t="default",padding:a="md",children:s,...i},r)=>(0,o.jsx)("div",{ref:r,className:`rounded-2xl ${{default:"bg-white",bordered:"bg-white border border-slate-200",elevated:"bg-white shadow-lg shadow-rose-100/40",warm:"bg-gradient-to-br from-rose-50 via-white to-violet-50 border border-white"}[t]} ${{none:"",sm:"p-4",md:"p-6",lg:"p-8"}[a]} ${e}`,...i,children:s}));function n({className:e="",variant:t="default",size:a="md",children:s,...i}){return(0,o.jsx)("span",{className:`inline-flex items-center font-medium rounded-full ${{default:"bg-slate-100 text-slate-700",rose:"bg-rose-100 text-rose-700",violet:"bg-violet-100 text-violet-700",amber:"bg-amber-100 text-amber-700",emerald:"bg-emerald-100 text-emerald-700"}[t]} ${{sm:"px-2 py-0.5 text-xs",md:"px-3 py-1 text-sm"}[a]} ${e}`,...i,children:s})}function l({value:e,max:t=100,variant:a="default",size:s="md",className:i=""}){let r=Math.min(100,Math.max(0,e/t*100)),n={sm:"h-1.5",md:"h-2.5",lg:"h-4"};return(0,o.jsx)("div",{className:`w-full ${i}`,children:(0,o.jsx)("div",{className:`w-full bg-slate-100 rounded-full overflow-hidden ${n[s]}`,children:(0,o.jsx)("div",{className:`${n[s]} ${{default:"bg-rose-500",success:"bg-emerald-500",warning:"bg-amber-500",gradient:"bg-gradient-to-r from-rose-500 via-violet-500 to-amber-400"}[a]} rounded-full transition-all duration-500 ease-out`,style:{width:`${r}%`}})})})}r.displayName="Card",e.s(["Card",()=>r],5050),e.s(["Badge",()=>n],89890),e.s(["ProgressBar",()=>l],83342),e.s([],4121)},6788,e=>{"use strict";var t=e.i(43476),a=e.i(71645),o=e.i(46932),s=e.i(88653),i=e.i(75254);let r=(0,i.default)("lightbulb",[["path",{d:"M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5",key:"1gvzjb"}],["path",{d:"M9 18h6",key:"x1upvd"}],["path",{d:"M10 22h4",key:"ceow96"}]]),n=(0,i.default)("send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]]),l=(0,i.default)("refresh-cw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]);var u=e.i(95468);let d=(0,i.default)("circle-alert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]),c=(0,i.default)("chevron-down",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);e.i(98640);var h=e.i(89416);let m=["you are","act as","act like","be a","be an","be my","play a","pretend","imagine you","as a","coach","tutor","friend","mentor","recruiter","advisor","teacher","assistant","expert","role of"],p=["rewrite","draft","write","plan","list","quiz","explain","compare","summarise","summarize","suggest","give me","show me","turn this","help me with","build","create","review","fix","improve","tailor"],y=["my","our","i have","i'm","i am","we have","currently","situation","context","background","budget","timeline","earning","earn","rent","income","student","job","uni","university","course","deadline","week","month","constraint","goal"],g=["bullet","bullets","list","table","paragraph","word","words","characters","under","max","maximum","minimum","format","structure","items","points","summary","length","lines","keep it","make it","no longer than"];function f(e,t){let a=e.toLowerCase(),o=t.filter(e=>a.includes(e.toLowerCase()));if(0===o.length)return{present:!1,quality:"none"};let s=o[0],i=a.indexOf(s.toLowerCase()),r=Math.max(0,i-20),n=Math.min(e.length,i+s.length+50),l=e.slice(r,n).trim(),u="weak";if(o.length>=3)u="strong";else{let e=/\d+/.test(l),t=/\$|%|years?|months?|weeks?|days?|hours?/.test(l);(e||t)&&(u="good")}return{present:!0,quality:u,snippet:l.length>80?l.slice(0,80)+"...":l}}let w={none:0,weak:10,good:18,strong:25};e.i(4121);var b=e.i(76525),x=e.i(5050),k=e.i(89890),v=e.i(83342);function I({scenario:e,isSelected:a,onClick:o}){let s=h.difficultyLabels[e.difficulty],i={"life-admin":"🏠",learning:"📚",career:"💼"}[e.squad];return(0,t.jsxs)("button",{onClick:o,className:`w-full text-left p-4 rounded-2xl border transition-all ${a?"border-rose-400 bg-rose-50":"border-slate-200 bg-white hover:border-rose-300 hover:bg-rose-50/50"}`,children:[(0,t.jsxs)("div",{className:"flex items-start justify-between mb-1 gap-2",children:[(0,t.jsxs)("div",{className:"flex items-start gap-2 min-w-0",children:[(0,t.jsx)("span",{className:"text-lg shrink-0",children:i}),(0,t.jsx)("h3",{className:"font-medium text-slate-900 leading-snug",children:e.title})]}),(0,t.jsx)(k.Badge,{size:"sm",className:s.color,children:s.label})]}),(0,t.jsx)("p",{className:"text-xs text-slate-500 line-clamp-2 ml-7",children:e.description})]})}function j({label:e,present:a,quality:o}){let s={none:"bg-slate-200",weak:"bg-amber-400",good:"bg-rose-400",strong:"bg-gradient-to-r from-rose-500 to-violet-500"};return(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsx)("span",{className:"text-xs font-semibold text-slate-600 w-6",children:e}),(0,t.jsx)("div",{className:"flex-1 h-2 bg-slate-100 rounded-full overflow-hidden",children:(0,t.jsx)("div",{className:`h-full ${s[o]||s.none} rounded-full transition-all`,style:{width:a?"strong"===o?"100%":"good"===o?"70%":"40%":"0%"}})})]})}let N={role:"R",instructions:"I",parameters:"P",expected:"E"};function A(){var e;let[i,A]=(0,a.useState)(h.practiceScenarios[0]),[q,W]=(0,a.useState)(""),[T,S]=(0,a.useState)(null),[D,M]=(0,a.useState)(!1),$=()=>{W(""),S(null),M(!1)},C=T?(e=T.score)>=70?{label:"Excellent",color:"text-rose-600"}:e>=50?{label:"Good",color:"text-violet-600"}:e>=30?{label:"Needs work",color:"text-amber-600"}:{label:"Just getting started",color:"text-slate-500"}:null;return(0,t.jsx)("div",{className:"py-12 px-4 sm:px-6",children:(0,t.jsxs)("div",{className:"max-w-5xl mx-auto",children:[(0,t.jsxs)("div",{className:"text-center mb-8",children:[(0,t.jsx)(k.Badge,{variant:"amber",size:"sm",className:"mb-3",children:"Practice"}),(0,t.jsx)("h1",{className:"text-3xl md:text-4xl font-bold text-slate-900 mb-3",children:"Write your own. We'll score it."}),(0,t.jsx)("p",{className:"text-slate-600 max-w-2xl mx-auto",children:"Pick a real-life scenario, write a prompt using RIPE, and get instant feedback on what's missing."})]}),(0,t.jsxs)("div",{className:"grid lg:grid-cols-3 gap-6",children:[(0,t.jsxs)("div",{className:"lg:col-span-1 space-y-3",children:[(0,t.jsx)("h2",{className:"font-semibold text-slate-900 mb-2",children:"Pick a scenario"}),h.practiceScenarios.map(e=>(0,t.jsx)(I,{scenario:e,isSelected:i.id===e.id,onClick:()=>{A(e),$()}},e.id))]}),(0,t.jsxs)("div",{className:"lg:col-span-2 space-y-5",children:[(0,t.jsxs)(x.Card,{variant:"bordered",padding:"lg",children:[(0,t.jsx)("h2",{className:"text-xl font-semibold text-slate-900 mb-2",children:i.title}),(0,t.jsx)("p",{className:"text-slate-600 mb-4",children:i.description}),(0,t.jsxs)("div",{className:"p-4 bg-gradient-to-r from-rose-50 to-violet-50 rounded-xl border border-rose-100",children:[(0,t.jsx)("div",{className:"text-xs font-semibold text-rose-700 mb-1 uppercase tracking-wide",children:"Your goal"}),(0,t.jsx)("p",{className:"text-sm text-slate-800",children:i.goal})]}),(0,t.jsxs)("button",{onClick:()=>M(!D),className:"flex items-center gap-2 mt-4 text-sm text-slate-500 hover:text-rose-600",children:[(0,t.jsx)(r,{size:14}),D?"Hide hints":"Show hints",(0,t.jsx)(c,{size:14,className:`transition-transform ${D?"rotate-180":""}`})]}),(0,t.jsx)(s.AnimatePresence,{children:D&&(0,t.jsx)(o.motion.div,{initial:{height:0,opacity:0},animate:{height:"auto",opacity:1},exit:{height:0,opacity:0},className:"overflow-hidden",children:(0,t.jsx)("ul",{className:"mt-3 space-y-1",children:i.hints.map((e,a)=>(0,t.jsxs)("li",{className:"text-sm text-amber-700",children:["• ",e]},a))})})})]}),(0,t.jsxs)(x.Card,{variant:"bordered",padding:"lg",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-2",children:[(0,t.jsx)("h3",{className:"font-medium text-slate-900",children:"Your prompt"}),(0,t.jsxs)("span",{className:"text-xs text-slate-400",children:[q.length," chars"]})]}),(0,t.jsx)("textarea",{value:q,onChange:e=>W(e.target.value),placeholder:"Write your prompt here — remember RIPE: Role, Instructions, Parameters, Expected.",className:"w-full h-40 p-4 border border-rose-100 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent text-slate-700",disabled:!!T}),(0,t.jsx)("div",{className:"flex gap-3 mt-4",children:T?(0,t.jsxs)(b.Button,{variant:"secondary",onClick:$,children:[(0,t.jsx)(l,{size:14,className:"mr-2"}),"Try again"]}):(0,t.jsxs)(b.Button,{onClick:()=>{if(q.trim()){let e,t,a,o,s,i,r;S((e=f(q,m),t=f(q,p),a=f(q,y),o=f(q,g),s=w[e.quality]+w[t.quality]+w[a.quality]+w[o.quality],i=[],e.present?"weak"===e.quality&&i.push("Add a vibe to the Role — honest, gentle, blunt, playful."):i.push("Give AI a Role — e.g., 'Act like a budget coach who's realistic not preachy'."),t.present||i.push("Your Instructions are vague — start with a verb (rewrite, plan, quiz, draft)."),a.present?"weak"===a.quality&&i.push("Make Parameters more concrete — add numbers, dates, or a real constraint."):i.push("Add some Parameters — who are you, what's your situation, what's the deadline?"),o.present?"weak"===o.quality&&i.push("Be more specific about Expected — how many items? How many words?"):i.push("Say what you want back — format, length, tone. 'Under 80 words, as a list.'"),r="generic",s>=70?r="excellent":s>=40&&(r="adequate"),{score:s,ripeAnalysis:{role:e,instructions:t,parameters:a,expected:o},suggestions:i,tier:r}))}},disabled:!q.trim(),children:[(0,t.jsx)(n,{size:14,className:"mr-2"}),"Analyse"]})})]}),(0,t.jsx)(s.AnimatePresence,{children:T&&(0,t.jsx)(o.motion.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},children:(0,t.jsxs)(x.Card,{variant:"warm",padding:"lg",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-4 flex-wrap gap-2",children:[(0,t.jsx)("h3",{className:"font-semibold text-slate-900",children:"Feedback"}),(0,t.jsxs)("div",{className:"flex items-baseline gap-2",children:[(0,t.jsx)("span",{className:`text-3xl font-bold ${C?.color}`,children:T.score}),(0,t.jsxs)("span",{className:"text-sm text-slate-500",children:["/100 · ",C?.label]})]})]}),(0,t.jsx)(v.ProgressBar,{value:T.score,variant:T.score>=70?"gradient":"warning",className:"mb-6"}),(0,t.jsx)("div",{className:"grid grid-cols-2 gap-4 mb-6",children:["role","instructions","parameters","expected"].map(e=>(0,t.jsx)(j,{label:N[e],present:T.ripeAnalysis[e].present,quality:T.ripeAnalysis[e].quality},e))}),T.suggestions.length>0&&(0,t.jsxs)("div",{className:"mb-6",children:[(0,t.jsx)("h4",{className:"text-sm font-semibold text-slate-700 mb-2",children:"Suggestions"}),(0,t.jsx)("ul",{className:"space-y-2",children:T.suggestions.map((e,a)=>(0,t.jsxs)("li",{className:"flex items-start gap-2 text-sm text-slate-700",children:[(0,t.jsx)(d,{size:14,className:"text-amber-500 shrink-0 mt-0.5"}),e]},a))})]}),(0,t.jsxs)("div",{className:"pt-4 border-t border-rose-100",children:[(0,t.jsxs)("h4",{className:"text-sm font-semibold text-slate-700 mb-2 flex items-center gap-2",children:["excellent"===T.tier?(0,t.jsx)(u.CheckCircle2,{size:14,className:"text-emerald-500"}):(0,t.jsx)(d,{size:14,className:"text-amber-500"}),"What AI might reply with (",T.tier,")"]}),(0,t.jsx)("div",{className:"p-4 bg-white rounded-xl border border-rose-100 text-sm text-slate-700 max-h-64 overflow-y-auto whitespace-pre-wrap",children:i.responses[T.tier]})]})]})})})]})]})]})})}e.s(["default",()=>A],6788)}]);